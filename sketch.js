...
function setup() {
  ...
  //var arrow =new PlayerArrow(100,100,100,10);
...
//arrow.display()
 // Use for loop to display arrow using showArrow() functionshowArrows();
            // arrow.display();
...
function keyReleased () {
 ...
 Matter.Body.setAngle(arrow.body, angle);
    ...
    //var arrow = new PlayerArrows(playerArcher.x,playerArcher.y)
//arrows.push(arrow);
//var posX = playerArcher.body.position.x;
  // var posY = playerArcher.body.position.y;
  // var angle = playerArcher.body.angle+PI/2;
...
function showArrows(index, arrows) {
 ...
 arrow[index].display();
 //if (arrow.body.position.x >= width|| ball.body.position.y) {
